// $Id: Sentence.cpp 3222 2010-05-03 21:41:28Z bojar $
// vim:tabstop=2
...
Last modified by Ventsislav Zhechev on 20 Jun 2010
...
int Sentence::Read(std::istream& in,const std::vector<FactorType>& factorOrder) 
{
	...
	if (getline(in, line, '\n').eof())	
			return 0;
//	VERBOSE(1, "Translating (Sentence before Trim): " << line << endl);

	// remove extra spaces
	line = Trim(line);
	
//	VERBOSE(1, "Translating (Sentence after Trim): " << line << endl);
